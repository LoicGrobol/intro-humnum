...
Permettre aux chercheurs de visualiser en un clic des reproductions numériques d’originaux, qui
autrement sont difficiles d'accès et d'outils de recherche (index, apparat critique, moteur de
recherche) pour explorer le corpus.
