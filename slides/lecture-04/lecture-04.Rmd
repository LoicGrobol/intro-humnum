...
La [table des
fréquences](https://voyant-tools.huma-num.fr/?corpus=084f1ee1a8ff6e370da5b98a3d19a71b&view=DocumentTerms)
...
[Le
concordancier](https://voyant-tools.huma-num.fr/?corpus=084f1ee1a8ff6e370da5b98a3d19a71b&query=father&view=Contexts)
...
- Trouver une bonne liste de mots vide n'est pas forcément évident ici
...
Français, espagnol et anglais : [*Digital Humanities Quarterly* 12.1](http://www.digitalhumanities.org/dhq/vol/12/1/), numéro de revue sur les humanités numériques hispanophones et francophones, en accès libre (licence CC-BY-ND) à charger en version nettoyée depuis [le dépôt](https://github.com/aurelberra/voyant_tools/blob/master/data/dhq_12_1_xml.zip)
