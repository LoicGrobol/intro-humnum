...
- L’infrastructure de support (ex. moteur de recherche, plateforme de stockage, etc.).
...
Stocker durablement les données et les métadonnées et à faciliter
leur accès et/ou leur téléchargement, en spécifiant les conditions
d’accès (accès ouvert ou restreint) et d’utilisation (licence) :
...
- I1 Les données et les métadonnées utilisent un langage formel, accessible, partagé et largement
  applicable pour la représentation des connaissances.
...
innovation, reproduction et/ou transparence de la science) :
