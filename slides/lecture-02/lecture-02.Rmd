...
L'auteurice du document doit fournir suffisament de contexte pour son interprétation et ses
destinataires intégrer ce contexte pour l'interpréter de la façon prévue.
...
- La structure *générique* : liée au genre, à la convention de communication. Ainsi un article
  contient toujours une introdroduction, des sections suivant un plan plus ou moins stéréotypé, une
  conclusion…

## Métadonnées

Des documents qui décrivent (et éventeullement identifient) des documents :
...
- Standard — interopérable : par qui et comment le document est-il lisible ? Est-il portable ?
  ...
  - Ou de facto (doc, gif), qui peut devenir officiel (JPG, PDF)
