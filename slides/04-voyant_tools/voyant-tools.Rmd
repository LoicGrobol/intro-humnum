...
- Avez-vous testé les fonctions de requête ? Comment sont répartis les mots commençant par « death » dans ce texte ?
...
- Avez-vous remarqué les curseurs, en particulier celui qui se nomme « Contexte » ? À quoi sert-il ?
...
Français, espagnol et anglais : [*Digital Humanities Quarterly* 12.1](http://www.digitalhumanities.org/dhq/vol/12/1/), numéro de revue sur les humanités numériques hispanophones et francophones, en accès libre (licence CC-BY-ND) à charger en version nettoyée depuis [le dépôt](https://github.com/aurelberra/voyant_tools/blob/master/data/dhq_12_1_xml.zip?raw=true)
